...
import { migrateLegacy, migrateScores, migrateInvestment, migrateHackathonInfo, migrateSpeakerNotes, migrateSpeakerBreak, migrateJudgingGroups, migrateDemoSlots, migrateVoiceAndRules, migrateEmailSends, migrateVoiceAgent, migratePasswordPlain, migrateProjectLinks } from './migrate.js';
...
export async function ensureSeed() {
  ...
  await migrateProjectLinks();  // add app_url + agent_evals_link to projects
